...
<h2>UI</h2>
I reworked the existing UI to improve the visual experience and responsiveness to inputs. An overview of the UI is demonstrated in the video below:
<!--
<video src="../assets/videos/tha-ui.mp4" style="aspect-ratio:3/4; width:80%;" controls></video>
<p class="caption center-horizontal" style="margin-top:5px; width:80%;">
  <i>Spatial UI of the Hololens app (@Balgrist, 2025).</i>
</p>
-->
