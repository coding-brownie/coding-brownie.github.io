...
<div>
  ...
  <p class="caption" style="margin-top:10px;">
      <i>Object segmentation from a colored point-cloud with Mask3D and affordance predictions (in red) including orientation for a SitDown and Place affordance.</i>
  </p>
</div>
<p>
  The point-clouds of the detected objects and the best interaction points are sent back to the AR application, where they are again merged with existing object instances or instantiated as a completely new instance.<br/>
